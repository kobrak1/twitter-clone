  ...
  return (
    <nav className="mt-0.5 mb-1">
        <NavLink to='/' className="py-1 block group">
            {({isActive}) => (
                            <div className={classNames("p-3 rounded-full inline-flex items-center gap-5 hover:bg-[#eff3f41a] transition-colors", {'font-bold':isActive} )}>
                            {!isActive && (
        ...
        <NavLink to='/communities' className="py-1 block group">
            {({isActive}) => (
                            <div className={classNames("p-3 rounded-full inline-flex items-center gap-5 hover:bg-[#eff3f41a] transition-colors", {'font-bold':isActive} )}>
                            {!isActive && (
                                <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
